...
def model(Y, T, params):
	a0, not_a0, q0, not_q0,a1, not_a1, q1, not_q1,a2, not_a2, q2, not_q2,i1, i2, i3, i4, i5, i6,=Y
	alpha1, alpha2, alpha3, alpha4, delta1, delta2, Kd, n, deltaE, KM,alpha_a, delta_a, Kd_a, n_a,KD_cond,=params
	clk = get_clock(T)
	cond0=0
	RESET0=max((inhibition(i4, cond0, KD_cond),)) if T > 1 else 100
	SET0=0 
	...
	return [da0_dt,dnot_a0_dt,dq0_dt,dnot_q0_dt,da1_dt,dnot_a1_dt,dq1_dt,dnot_q1_dt,da2_dt,dnot_a2_dt,dq2_dt,dnot_q2_dt,di1_dt,di2_dt,di3_dt,di4_dt,di5_dt,di6_dt]