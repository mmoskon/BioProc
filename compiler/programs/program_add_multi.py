...
def model(Y, T, params):
	a0, not_a0, q0, not_q0,a1, not_a1, q1, not_q1,a2, not_a2, q2, not_q2,a3, not_a3, q3, not_q3,i1, i2, i3, i4, i5, i6, i7, i8,A,B,C,D,E,=Y
	...
	dE_dt=+prog_alpha_E*activate_2(i1,A,prog_Kd_E,prog_n_E)+prog_alpha_E*activate_2(i1,B,prog_Kd_E,prog_n_E)-prog_delta_E*E
	dC_dt=+prog_alpha_C*activate_2(i2,A,prog_Kd_C,prog_n_C)+prog_alpha_C*activate_2(i2,B,prog_Kd_C,prog_n_C)-prog_delta_C*C
	dD_dt=+prog_alpha_D*hybrid_AAR(i2,A,B,prog_Kd_D,prog_n_D)-prog_delta_D*D
	RESET0=0 if T > 1 else 100
	SET0=0 
	RESET1=0 if T > 1 else 100
	SET1=0 
	RESET2=max((i4,)) if T > 1 else 100
	SET2=0 
	...
	return [da0_dt,dnot_a0_dt,dq0_dt,dnot_q0_dt,da1_dt,dnot_a1_dt,dq1_dt,dnot_q1_dt,da2_dt,dnot_a2_dt,dq2_dt,dnot_q2_dt,da3_dt,dnot_a3_dt,dq3_dt,dnot_q3_dt,di1_dt,di2_dt,di3_dt,di4_dt,di5_dt,di6_dt,di7_dt,di8_dt,dA_dt,dB_dt,dC_dt,dD_dt,dE_dt]